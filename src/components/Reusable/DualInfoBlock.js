    ...
    <section className='my-4 py-4 bg-theme'>
       <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-4">
          <div className="card">
  <img src="https://pixabay.com/photos/coffee-drink-caffeine-beverage-cup-6371149/" className="card-img-top" alt="image"/>
  <div className="card-body">
    <h5 className="card-title text-success">Just Write Code</h5>
    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content. Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti,natus voluptate porro nobis et impedit totam minima eius magnam eos maiores unde omnis beatae laborum illum neque nemo praesentium minus commodi quae aliquam amet.</p>
    <Link t0="/" className="btn btn-warning btn-block">{heading}</Link>
  </div>
</div>
          </div>
        </div>
